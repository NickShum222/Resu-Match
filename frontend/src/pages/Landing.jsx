    ...
    <>
      ...
      >
        <div className="w-full flex justify-end items-center text-white">
          <Link to="/login">
            <Button
              className="rounded-none normal-case py-3 px-8 font-normal text-[12px] md:text-[14px] lg:text-[16px]   text-highlight transition-all hover:bg-primary/40 active:bg-primary disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none bg-transparent"
        ...
        <div className="flex justify-center items-center  flex-col">
          ...
          <div className="flex justify-center items-center w-full mt-5">
            ...
            <Button
              size="sm"
              className={`text-[20px] border-t-[1px] border-r-[1px] border-b-[1px] border-white font-normal normal-case rounded-r-full px-5 py-2 ${email ? "bg-primary text-white" : "bg-primary/40 text-[#bfbfbf]"}`}
              onClick={toSignup}
